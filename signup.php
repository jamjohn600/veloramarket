      ...
      <div class="row g-5 align-items-center">
        <div class="col-lg-5">
          <div class="account__wrapper">
            ...
            <form class="account__form" id="signupForm">
              <div class="form-floating mb-4">
                <input type="text" class="form-control" id="floatingInput-user" name="username" placeholder="username"
                  required>
              ...
              <div class="form-floating mb-4">
                <input type="password" class="form-control" id="floatingPassword2" name="confirm_password"
              ...
              <div class="form-group">
                <button class="d-block custom-btn move-top" type="submit" id="signupBtn"><span>Signup
                    Now</span></button>
              </div>
            </form>
            <div class="account-bottom">
              <p class="d-block cate pt-10">Have an Account? <a href="signin.php">Sign in</a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-7">
