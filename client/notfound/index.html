...
<!-- Mirrored from crypo-laravel-live.netlify.app/notfound/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Sep 2024 05:20:10 GMT -->
...
<body id="dark">
  <header class="dark-bb">
    <nav class="navbar navbar-expand-lg">
      <a class="navbar-brand" href="../index.html"><img src="../assets/img/logo-light.svg" alt="logo"></a>
  ...
  <div class="error-page vh-100 d-flex justify-content-center text-center">
    <div class="my-auto">
      ...
      <a href="../index.html" class="btn">Back to Home <i class="icon ion-md-home"></i></a>
    </div>
  </div>
