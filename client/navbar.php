...
<nav class="navbar navbar-expand-lg">
      ...
      <div class="collapse navbar-collapse" id="headerMenu">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="../index.php"><i class="icon ion-md-swap"></i> Trade</a>
                </li>
                <!--<li class="nav-item">-->
                <!--    <a class="nav-link" href="../markets"><i class="icon ion-md-stats"></i> Markets</a>-->
                <!--</li>-->
                <li class="nav-item">
                    <a class="nav-link" href="../profile"><i class="icon ion-md-person"></i> Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../wallet"><i class="icon ion-md-wallet"></i> Wallet</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../settings"><i class="icon ion-md-settings"></i> Settings</a>
                </li>
            </ul>
